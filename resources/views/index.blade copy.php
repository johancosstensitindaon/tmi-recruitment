    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div
            ...
            <a href="{{ route('landing') }}" class="logo d-flex align-items-center me-auto me-xl-0">
                <h1 class="sitename">
                    <img src="{{ asset('tmi/logo.png') }}" alt="">
                </h1>
            </a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="hero-image" data-aos="zoom-out" data-aos-delay="300">
                            <img src="{{ asset('landing/assets/img/illustration-1.webp') }}" alt="Hero Image"
                                class="img-fluid">

                            <div class="customers-badge">
                                <div class="customer-avatars">
                                    <img src="{{ asset('landing/assets/img/avatar-1.webp') }}" alt="Customer 1"
                                        class="avatar">
                                    <img src="{{ asset('landing/assets/img/avatar-2.webp') }}" alt="Customer 2"
                                        class="avatar">
                                    <img src="{{ asset('landing/assets/img/avatar-3.webp') }}" alt="Customer 3"
                                        class="avatar">
                                    <img src="{{ asset('landing/assets/img/avatar-4.webp') }}" alt="Customer 4"
                                        class="avatar">
                                    <img src="{{ asset('landing/assets/img/avatar-5.webp') }}" alt="Customer 5"
                                        class="avatar">
                            ...
                            <div class="row gy-4">
                                <div class="col-lg-5">
                                    <div class="profile d-flex align-items-center gap-3">
                                        <img src="{{ asset('landing/assets/img/avatar-1.webp') }}" alt="CEO Profile"
                                            class="profile-image">
                                        <div>
                    ...
                    <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="image-wrapper">
                            <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                                <img src="{{ asset('landing/assets/img/about-5.webp') }}" alt="Business Meeting"
                                    class="img-fluid main-image rounded-4">
                                <img src="{{ asset('landing/assets/img/about-2.webp') }}" alt="Team Discussion"
                ...
                <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="tab-pane fade active show" id="features-tab-1">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{ asset('landing/assets/img/features-illustration-1.webp') }}"
                                    alt="" class="img-fluid">
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="features-tab-2">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{ asset('landing/assets/img/features-illustration-2.webp') }}"
                                    alt="" class="img-fluid">
                            </div>
                        </div>
                    </div><!-- End tab content item -->
                    ...
                    <div class="tab-pane fade" id="features-tab-3">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{ asset('landing/assets/img/features-illustration-3.webp') }}"
                                    alt="" class="img-fluid">
                            </div>
                        </div>
                    </div><!-- End tab content item -->
