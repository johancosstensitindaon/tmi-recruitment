            ...
            <div class="card h-md-100" dir="ltr">
                ...
                <div class="card-body d-flex flex-column flex-center">
                    ...
                    <div class="text-center mb-1">
                        ...
                        <!--end::Link-->
                        <!--begin::Link-->
                        <a class="btn btn-sm btn-light" href="../../demo38/dist/apps/invoices/view/invoice-1.html">Learn
                            more</a>
                        <!--end::Link-->
                    </div>
                    <!--end::Links-->
        ...
        <div class="col-xl-4 mb-xl-10">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-7 mb-5">
                    ...
                    <!--begin::Toolbar-->
                    <div class="card-toolbar">
                        <a href="../../demo38/dist/apps/ecommerce/sales/listing.html" class="btn btn-sm btn-light">View
                            All</a>
                    </div>
                    <!--end::Toolbar-->
                </div>
